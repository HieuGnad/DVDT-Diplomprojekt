...
--1:1 Beziehungen mit dem Patienten müssen vor dem Patienten eingefügtwerden.
INSERT INTO `spengermed`.`p_patient` (`id`, `p_active`,`p_deceasedboolean`, `p_gender`) VALUES ('643221yu', false, true, 'other');
--1:n Beziehungen mit dem Patienten müssen nach dem Patienten eingefügtwerden
...
--MAÜ4 INSERT----------------------------------------------------------
INSERT INTO `spengermed`.`cm_communication` (`id`,`cm_content_attachment`,`cm_content_string`,`cm_priority`,`cm_received`) VALUES('Hieu1', 'test', 'test', 'asap', 'test');
INSERT INTO `spengermed`.`cm_communication` (`id`,`cm_content_attachment`,`cm_content_string`,`cm_priority`,`cm_received`) VALUES('Hieu2', null, null, 'asap', null);

INSERT INTO `spengermed`.`pr_practitioner` (`id`, `pr_active`, `pr_gender`) VALUES ('hieu', true, 'male');

INSERT INTO `spengermed`.`en_encounter` (`id`) VALUES ('nextweek');

INSERT INTO `spengermed`.`ri_riskassessment` (`id`, `ri_status`) VALUES ('1', 'registered');
INSERT INTO `spengermed`.`ri_riskassessment` (`id`, `ri_status`) VALUES ('2', 'preliminary');
INSERT INTO `spengermed`.`ri_riskassessment` (`id`, `ri_status`) VALUES ('3', 'amended');
INSERT INTO `spengermed`.`ri_riskassessment` (`id`, `ri_status`) VALUES ('3', 'amended');
INSERT INTO `spengermed`.`ri_prediction` (`id`, `prediction`) VALUES ('1', '99');