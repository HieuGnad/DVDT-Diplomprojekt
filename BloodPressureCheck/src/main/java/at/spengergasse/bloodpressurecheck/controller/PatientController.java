package at.spengergasse.bloodpressurecheck.controller;
...
public class PatientController {
    ...
    public ResponseEntity<Patient> createPatient( @Valid @RequestBody Patient
        ...
        Patient p = Patient.builder().active(true).build();
    ...
    // Update a Patient
    @PutMapping("/{id}")
    public ResponseEntity<Patient> updatePatient(@PathVariable(value = "id")
                                                         String patientId, @RequestBody Patient patientDetails) {
